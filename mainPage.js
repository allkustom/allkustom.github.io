...
//-----------------------------------------------------------------------------------------------------------------------------------
    ...
    function motionLink(){
        setTimeout(function(){
            window.location.href = "allworks.html#motionTag";
        },artLinkTimer)
    }

    function imageLink(){
        setTimeout(function(){
            window.location.href = "allworks.html#imageTag";
        },artLinkTimer)
    }

    function codeLink(){
        setTimeout(function(){
            window.location.href = "allworks.html#codeTag";
        },artLinkTimer)
    }

    function physicalLink(){
        setTimeout(function(){
            window.location.href = "allworks.html#physicalTag";
        },artLinkTimer)
    }
